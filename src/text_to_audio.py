...
def generate_audio(bin_dir: str, filename: str, cleaned_page_content_map: dict[int,str], voice: str) -> dict[int,list]:
...
def text_to_audio(bin_dir: str, filename: str, page: int, content: str, voice: str) -> list:
    client = OpenAI()
    max_characters = 4096
    ...
    if len(content) <= max_characters:
        ...
        speech_file_path1 = os.path.join(bin_dir, f"{filename}_{page}_part1.mp3")
        speech_file_path2 = os.path.join(bin_dir, f"{filename}_{page}_part2.mp3")
